...
namespace SampleText_Restaurant_Review.Pages.Requests
{
    ...
    public class AcceptModel : PageModel
    {
        ...
        public AcceptModel(SampleText_Restaurant_Review.Data.SampleText_Restaurant_ReviewContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> OnPostAsync(int? id)
        {
            ...
            if (RestaurantRequests != null)
            {
                ...
                restaurant.Name = RestaurantRequests.Name;
                ...
                if (await _context.SaveChangesAsync() > 0)
                {
                    ...
                    auditrecord.AuditActionType = "Accepted Restaurant";
